      ...
      {prices.length !== 1 ? (
        <LinearGradient
          ...
          <View style={styles.CartItemRow}>
            <Image source={{uri: `http://localhost:3000/images/${imagelink_square}`}} style={styles.CartItemImage} />
            ...
            <View key={index.toString()} style={styles.CartItemSizeRowContainer}>
              ...
              <View style={styles.CartItemSizeValueContainer}>
                <TouchableOpacity
                  ...
                  <CustomIconConfig name="minus" color={COLORS.primaryWhiteHex} size={FONTSIZE.size_10} />
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  ...
                  <CustomIconConfig name="add" color={COLORS.primaryWhiteHex} size={FONTSIZE.size_10} />
                </TouchableOpacity>
              </View>
            </View>
          ))}
