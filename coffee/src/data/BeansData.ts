...
const BeansData = [
  {
    ...
    imagelink_square: require('../assets/coffee_images/robusta_coffee_beans/robusta_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/coffee_images/robusta_coffee_beans/robusta_coffee_beans_portrait.png'),
    ingredients: 'Africa',
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_images/arabica/arabica_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/coffee_images/arabica/arabica_coffee_beans_portrait.png'),
    ingredients: 'Africa',
    special_ingredient: 'From Africa',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_images/liberica_coffee_beans/liberica_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/coffee_images/liberica_coffee_beans/liberica_coffee_beans_portrait.png'),
  ...
  },
  {
    ...
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_images/excelsa_coffee_beans/excelsa_coffee_beans_square.png'),
    imagelink_portrait: require('../assets/coffee_images/excelsa_coffee_beans/excelsa_coffee_beans_portrait.png'),
    ingredients: 'Malaysia',
    special_ingredient: 'From Malaysia',
    prices: [
      {size: '250gm', price: '5.50', currency: '$'},
