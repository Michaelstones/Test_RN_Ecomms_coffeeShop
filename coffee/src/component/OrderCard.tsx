...
const OrderCard = ({type, name, imagelink_square, special_ingredient, prices, ItemPrice}: OrderCardProps) => {
  return (
    <LinearGradient
      start={{x: 0, y: 0}}
      end={{x: 1, y: 1}}
      ...
      <View style={styles.CardInfoContainer}>
        <View style={styles.CardImageInfoContainer}>
          <Image source={{uri: `http://localhost:3000/images/${imagelink_square}`}} style={styles.Image} />
          <View>
