const CoffeeData = [
  {
    ...
    imagelink_square: "americano/square/americano_pic_1_square.png",
    imagelink_portrait: "americano/portrait/americano_pic_1_portrait.png",
    ingredients: "Milk",
  ...
  },
  {
    ...
    description:
      "The Americano is another popular type of coffee drink, and it's very easy to make! It's just espresso with hot water dripping over it. The name came about during World War II when European baristas added water to their espresso drinks for the American soldiers stationed there. The resulting drink had a smoother, less concentrated flavour than espresso and thus the Americano was born.",
    roasted: "Medium Roasted",
    imagelink_square: "americano/square/americano_pic_2_square.png",
    imagelink_portrait: "americano/portrait/americano_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description:
      "The Americano is another popular type of coffee drink, and it's very easy to make! It's just espresso with hot water dripping over it. The name came about during World War II when European baristas added water to their espresso drinks for the American soldiers stationed there. The resulting drink had a smoother, less concentrated flavour than espresso and thus the Americano was born.",
    roasted: "Medium Roasted",
    imagelink_square: "americano/square/americano_pic_3_square.png",
    imagelink_portrait: "americano/portrait/americano_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "black_coffee/square/black_coffee_pic_1_square.png",
    imagelink_portrait: "black_coffee/portrait/black_coffee_pic_1_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description:
      "Black coffee is arguably the most common type of coffee drink out there. Its popularity can be mainly attributed to how easy it is to make this beverage, be it drip, pour-over, French press, or anything else. Black coffee is usually served with no add-ins.",
    roasted: "Medium Roasted",
    imagelink_square: "black_coffee/square/black_coffee_pic_2_square.png",
    imagelink_portrait: "black_coffee/portrait/black_coffee_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "black_coffee/square/black_coffee_pic_3_square.png",
    imagelink_portrait: "black_coffee/portrait/black_coffee_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "cappuccino/square/cappuccino_pic_1_square.png",
    imagelink_portrait: "cappuccino/portrait/cappuccino_pic_1_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `Cappuccinos are a classic Italian type of coffee drink made of espresso, steamed milk, and thick foam in equal parts. The name comes from the resemblance to the hoods worn by Capuchin monks. Making cappuccino is relatively easy and can be done at home too if you know how to make espresso.`,
    roasted: "Medium Roasted",
    imagelink_square: "cappuccino/square/cappuccino_pic_2_square.png",
    imagelink_portrait: "cappuccino/portrait/cappuccino_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `Cappuccinos are a classic Italian type of coffee drink made of espresso, steamed milk, and thick foam in equal parts. The name comes from the resemblance to the hoods worn by Capuchin monks. Making cappuccino is relatively easy and can be done at home too if you know how to make espresso.`,
    roasted: "Medium Roasted",
    imagelink_square: "cappuccino/square/cappuccino_pic_3_square.png",
    imagelink_portrait: "cappuccino/portrait/cappuccino_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "espresso/square/espresso_pic_1_square.png",
    imagelink_portrait: "espresso/portrait/espresso_pic_1_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `Espresso is made by forcing nearly boiling water through finely-ground coffee beans, which results in a concentrated, syrup-like coffee drink. This is the base for many Italian beverages in coffee shops. When compared to regular brewed coffee, espresso is much stronger than the other types of coffee drinks. Espressos are enjoyed in shots where a single shot is one ounce and a long (single and double) shot is two ounces in amount, respectively.`,
    roasted: "Medium Roasted",
    imagelink_square: "espresso/square/espresso_pic_2_square.png",
    imagelink_portrait: "espresso/portrait/espresso_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `Espresso is made by forcing nearly boiling water through finely-ground coffee beans, which results in a concentrated, syrup-like coffee drink. This is the base for many Italian beverages in coffee shops. When compared to regular brewed coffee, espresso is much stronger than the other types of coffee drinks. Espressos are enjoyed in shots where a single shot is one ounce and a long (single and double) shot is two ounces in amount, respectively.`,
    roasted: "Medium Roasted",
    imagelink_square: "espresso/square/espresso_pic_3_square.png",
    imagelink_portrait: "espresso/portrait/espresso_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "latte/square/latte_pic_1_square.png",
    imagelink_portrait: "latte/portrait/latte_pic_1_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `A latte is an espresso with steamed milk and a dollop of milk foam on top. This beverage is more prevalent in America than other coffee drinks like cappuccinos because it contains less foam, making it smoother and gentler for those with sensitive palettes. And if you want to spice up your latte, add some flavouring syrup. To make an iced version of this drink, simply pour espresso and steamed milk over ice cubes.`,
    roasted: "Medium Roasted",
    imagelink_square: "latte/square/latte_pic_2_square.png",
    imagelink_portrait: "latte/portrait/latte_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `A latte is an espresso with steamed milk and a dollop of milk foam on top. This beverage is more prevalent in America than other coffee drinks like cappuccinos because it contains less foam, making it smoother and gentler for those with sensitive palettes. And if you want to spice up your latte, add some flavouring syrup. To make an iced version of this drink, simply pour espresso and steamed milk over ice cubes.`,
    roasted: "Medium Roasted",
    imagelink_square: "latte/square/latte_pic_3_square.png",
    imagelink_portrait: "latte/portrait/latte_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "macchiato/square/macchiato_pic_1_square.png",
    imagelink_portrait: "macchiato/portrait/macchiato_pic_1_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `The word "macchiato" means spotted, so a macchiato espresso is an espresso with a splash of milk. Most coffee shops will top off this type of coffee drink with some foamed milk instead of just steamed milk for what's known as a traditional macchiato. `,
    roasted: "Medium Roasted",
    imagelink_square: "macchiato/square/macchiato_pic_2_square.png",
    imagelink_portrait: "macchiato/portrait/macchiato_pic_2_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
  ...
  },
  {
    ...
    description: `The word "macchiato" means spotted, so a macchiato espresso is an espresso with a splash of milk. Most coffee shops will top off this type of coffee drink with some foamed milk instead of just steamed milk for what's known as a traditional macchiato. `,
    roasted: "Medium Roasted",
    imagelink_square: "macchiato/square/macchiato_pic_3_square.png",
    imagelink_portrait: "macchiato/portrait/macchiato_pic_3_portrait.png",
    ingredients: "Milk",
    special_ingredient: "With Steamed Milk",
    prices: [
      { size: "S", price: "1.38", currency: "$" },
...
const BeanData = [
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "robusta_coffee_beans/robusta_coffee_beans_square.png",
    imagelink_portrait:
      "robusta_coffee_beans/robusta_coffee_beans_portrait.png",
    ingredients: "Africa",
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "arabica/arabica_coffee_beans_square.png",
    imagelink_portrait: "arabica/arabica_coffee_beans_portrait.png",
    ingredients: "Africa",
    special_ingredient: "From Africa",
    prices: [
      { size: "250gm", price: "5.50", currency: "$" },
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "liberica_coffee_beans/liberica_coffee_beans_square.png",
    imagelink_portrait:
      "liberica_coffee_beans/liberica_coffee_beans_portrait.png",
  ...
  },
  {
    ...
    roasted: "Medium Roasted",
    imagelink_square: "excelsa_coffee_beans/excelsa_coffee_beans_square.png",
    imagelink_portrait:
      "excelsa_coffee_beans/excelsa_coffee_beans_portrait.png",
    ingredients: "Malaysia",
    special_ingredient: "From Malaysia",
    prices: [
      { size: "250gm", price: "5.50", currency: "$" },
